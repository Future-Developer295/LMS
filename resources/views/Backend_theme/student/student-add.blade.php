            ...
            <div class="form-grid">
                <div class="stack">
                    <div class="card card-pad">
                        <div class="upload-photo" id="photoTrigger"
                            style="background-size:cover;background-position:center;"><i class="fa-solid fa-camera"></i>
                        </div>
                        ...
                        <input type="file" name="student_img" id="photoInput" accept="image/png, image/jpeg"
                            style="display:none;">
                    </div>
                    ...
                    <div class="card card-pad">
                        ...
                        <div class="field mb-0">
                            ...
                            <input type="text" class="input" id="batch_code" name="batch_code" placeholder="e.g. B-2026"
                ...
                <div class="stack">
                    <div class="card card-pad">
                        ...
                        <div class="field-row">
                            <div class="field">
                                ...
                                <input type="text" class="input" id="full_name" name="full_name"
                                    placeholder="e.g. Jane Doe" value="{{ old('full_name') }}" required>
                            </div>
                            <div class="field">
                                <label for="last_name">Last Name</label>
                                <input type="text" class="input" id="last_name" name="last_name"
                                    placeholder="e.g. Jane Doe" value="{{ old('last_name') }}" required>
                            </div>
                        </div>
                        <div class="field-row">
                            <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="text" class="input" id="cnic" name="cnic" placeholder="987*****89"
                                value="{{ old('cnic') }}" required>
                        </div>
                        <div class="field mb-0">
                            <label for="email_address">Email Address</label>
                            <input type="email" class="input" id="email_address" name="email_address"
                                placeholder="name@eduadmin.edu" value="{{ old('email_address') }}">
                        </div>
                    </div>
            ...
            <div class="card card-pad mt-3">
                ...
                <div class="field-row">
                    <div class="field">
                        ...
                        <input type="text" class="input" id="father_name" name="father_name"
                            placeholder="Full Name" value="{{ old('father_name') }}" required>
                    </div>
                    <div class="field">
                        <label for="contact_number">Contact Number</label>
                        <input type="tel" class="input" id="contact_number" name="contact_number"
                            placeholder="+1 (555) 000-0000" value="{{ old('contact_number') }}" required>
                    </div>
                </div>
                <div class="field-row">
                    <div class="field">
                        <label for="emergency_contact">Emergency Contact</label>
                        <input type="tel" class="input" id="emergency_contact" name="emergency_contact"
                            placeholder="+1 (555) 000-0000" value="{{ old('emergency_contact') }}" required>
                    </div>
                </div>
                <div class="field mb-0">
