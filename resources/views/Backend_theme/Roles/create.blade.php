    ...
    <span class="current">Create Role</span>
        ...
        <div class="page-header">
            ...
            <div class="page-header-actions">
                <a href="{{route('roles.index')}}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back to Roles</a>
            </div>
        </div>
            ...
            <div class="form-sidebar-grid">
                ...
                <div class="role-details-sticky">
                    ...
                    <div class="card card-pad mb-lg">
                        ...
                        <div class="card-section-title">Role Details</div>
                    ...
                    <div class="card card-pad">
                        ...
                        <div style="display:flex;align-items:flex-start;gap:10px;">
                            ...
                            <i class="bi bi-info-circle-fill" style="color:var(--primary);font-size:16px;margin-top:2px;">
                            </i>

                            <p class="cell-muted" style="font-size:12.5px;margin:0;">
                                Permissions are grouped by module. Use "Select All"
                                to quickly grant every action within a module.
                            </p>
