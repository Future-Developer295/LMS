...
<body>
  ...
  <header class="gc-header d-flex align-items-center px-3 gap-2">
    ...
    <button class="btn-icon"><svg class="gb_H" aria-hidden="true" focusable="false" fill='#444746' viewBox="0 0 24 24">
    ...
    <div class="student-user-menu">
      ...
      <button id="logoutBtn" class="student-avatar">
        {{ strtoupper(substr(auth()->user()->name, 0, 2)) }}
      </button>

      <div id="logoutMenu" class="student-dropdown">
        ...
        <div class="student-dropdown-header">
          ...
          <div class="student-user-details">
            <strong>{{ auth()->user()->name }}</strong>
            <span>{{ auth()->user()->email }}</span>
          </div>
        </div>

        <div class="student-dropdown-line"></div>

        <a href="{{ route('student.profile') }}" class="student-dropdown-item">
        ...
        <form method="POST" action="{{ route('logout') }}">
          ...
          <button type="submit" class="student-dropdown-item student-logout">
    ...
    @else
    <a href="{{ route('login') }}" class="student-avatar text-decoration-none">
      <i class="fa-regular fa-user"></i>
    </a>
    @endif
  ...
  <div class="d-flex app-body">
    <nav class="gc-sidebar collapsed" id="sidebar">
      ...
      <a href="{{ route('student.attendance') }}" class="gc-nav-link @yield('attendance')">
    <i class="fa-solid fa-calendar-check" style="width:24px; font-size:20px;"></i>
          ...
          <div class="join-class-body">
            <div class="join-class-account-box">
              ...
              <div class="join-class-account-row">
                ...
                <div>
                  @if(auth()->check())
                  <div class="join-class-name">{{ auth()->user()->name }}</div>
                  <div class="join-class-email">{{ auth()->user()->email }}</div>
                  @endif
                </div>
              </div>
