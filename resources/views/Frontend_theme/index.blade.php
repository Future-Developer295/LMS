                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="gc-card">
                            ...
                            <a href="{{ route('steam') }}" class="text-decoration-none text-reset">
                                ...
                                <div class="gc-banner"
                                    ...
                                    <div class="gc-banner-teacher">
                                        {{ $joinedClass->teacher->full_name ?? 'Teacher' }}
                                    </div>
                            ...
                            <div class="gc-card-footer">
                                ...
                                <a href="{{ route('frontend_class') }}" class="btn-icon" title="Your work">
        ...
        @else
            <main class="flex-grow-1 d-flex align-items-center justify-content-center p-4">
                ...
                <div class="text-center">
                    ...
                    <div class="mb-3">
                        <i class="fa-solid fa-chalkboard-user" style="font-size: 65px; color: #0F9D58;">
                        </i>
                    </div>
