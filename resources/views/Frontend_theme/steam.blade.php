                ...
                <div class="side-col">
                    <div class="upcoming-panel">
                        ...
                        @forelse($upcoming as $assignment)
                            <a href="{{ route('detail', $assignment->id) }}" class="cell-link"
                        ...
                        <form class="announce-modal" method="POST" action="{{ route('announcement.store') }}">
                            ...
                            <div class="announce-modal-body">
                                <div class="announce-textbox">
                                    ...
                                    <div class="announce-editable" id="announceEditable" contenteditable="true">
                                    </div>
                            ...
                            <div class="announce-modal-footer">
                                ...
                                <div class="announce-action-btns">
                                    <button type="button" class="announce-cancel-btn" id="announceCancelBtn">
                                        Cancel
                                    </button>

                                    <button type="submit" class="announce-post-btn" id="announcePostBtn" disabled>
                                        Post
                                    </button>
                                </div>
